...
export default function AboutPage() {
  ...
  const faqs = [
    {
      question: 'What is ApproveMiner?',
      answer: 'ApproveMiner is a decentralized cloud mining platform that allows anyone to earn cryptocurrency rewards without owning or managing physical mining hardware. By pooling computing resources across our global network, we distribute mining profits proportionally to all participants.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Absolutely. ApproveMiner is a non-custodial platform, meaning we never hold your private keys or take custody of your funds. Your assets stay in your own wallet at all times, protected by enterprise-grade multi-layer encryption.'
    },
    {
    ...
    },
    {
      ...
      answer: 'ApproveMiner supports mining for multiple leading cryptocurrencies. The available assets can be selected through the platform and may vary based on current network conditions and profitability. Check the mining section for the latest supported assets.'
    },
    {
      question: 'Are there any fees?',
      answer: 'ApproveMiner operates on a transparent fee model. A small platform fee is deducted from gross mining earnings to cover infrastructure, maintenance, and operational costs. All fee details are visible before you activate mining — there are no hidden charges.'
    },
    {
    ...
    {
      question: 'Is ApproveMiner available in my country?',
      answer: 'ApproveMiner operates across 168+ countries worldwide. As long as you have access to a crypto wallet and the internet, you can participate. Please ensure you comply with any local regulations regarding cryptocurrency in your region.'
    },
    {
      question: 'Can I mine on a mobile device?',
      answer: 'Yes. ApproveMiner is fully optimized for mobile browsers, so you can manage your mining, track rewards, and monitor your team from any smartphone or tablet without needing to install a separate app.'
    },
    {
